  ...
  return (
    <motion.div 
        ...
        >
            ...
            <path d="M37.5 12.5V6.25C33.3962 6.25 29.3326 7.05831 25.5411 8.62876C21.7497 10.1992 18.3047 12.5011 15.4029 15.4029C9.5424 21.2634 6.25 29.212 6.25 37.5H12.5C12.5 30.8696 15.1339 24.5107 19.8223 19.8223C24.5107 15.1339 30.8696 12.5 37.5 12.5V12.5Z" fill='white' />
            </svg>
        </motion.div>
  )
}
